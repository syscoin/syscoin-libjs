...
var OffersService = /** @class */ (function () {
    function OffersService(httpClient, basePath, configuration) {
    ...
    OffersService.prototype.offerinfo = function (guid, observe, reportProgress) {
        ...
        return this.httpClient.get(this.basePath + "/offerinfo", {
    ...
    OffersService.prototype.offerlink = function (request, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        return this.httpClient.post(this.basePath + "/offerlink", request, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    OffersService.prototype.offernew = function (request, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        return this.httpClient.post(this.basePath + "/offernew", request, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    OffersService.prototype.offerupdate = function (request, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        return this.httpClient.post(this.basePath + "/offerupdate", request, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
